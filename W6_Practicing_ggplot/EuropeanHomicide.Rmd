...
_Answer_
I have choosen to use the geom_line command to create a better visualisation for a long-term trend. 

```{r creating a line for a long-term visualisation}
ggplot(data = Western_Europe) + 
...
_Answer_
To rename the color in the facet (but not permamently) I use the labs command to rename 'Entity' to 'Country'.
